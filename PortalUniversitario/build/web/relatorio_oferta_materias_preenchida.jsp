                ...
                <p>Departamento:<br/> <select name="departamento">
                    ...
                    <div style="margin-left:10px"> <p>Curso:<br/> <select name="curso" style="width: 260px;">
                        ...
                        <%
                            ...
                            <option value="<%= cursos.get(i).getNome()%>" <% if(request.getParameter("curso").equals(cursos.get(i).getNome())) { minSemestres = cursos.get(i).getMinSemestre();%> selected="selected" <%}%> ><%= cursos.get(i).getNome()%></option>
                        <%}%>
                    </select>
                    </p></div>
