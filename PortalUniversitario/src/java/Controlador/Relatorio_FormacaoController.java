 ...
 * @author John_Peter
 */
@WebServlet(name = "Relatorio_FormacaoController", urlPatterns = {"/Relatorio_FormacaoController"})
public class Relatorio_FormacaoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (opcao) {
            case "Buscar":
                dispatcher = request.getRequestDispatcher("relatorio_formacao_preenchida.jsp");
                dispatcher.forward(request, response);
                break;
            case "preencher":
                dispatcher = request.getRequestDispatcher("relatorio_formacao.jsp");
                dispatcher.forward(request,response);
                break;
            default:
                //alteração
